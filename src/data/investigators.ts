...
export const investigators: Investigator[] = [
  ...
  { id: 'ribas', wiki: 'es:Antonio_Ribera', name: 'Antonio Ribera', country: 'España', specialty: 'Ufología española', bio: 'Pionero de la ufología en España.', works: ['OVNI: El peligro nuclear (1979)'], credibility: 'histórico' },
