...
export const catalog: CatalogItem[] = [
  ...
  { id: 'ovni-tvn-1999', title: 'OVNI', year: 1999, director: 'Patricio Bañados', type: 'serie', synopsis: 'La serie documental de culto de TVN conducida por Patricio Bañados (1999–2000): dos temporadas que recorrieron los casos más famosos de la ufología chilena —Cabo Valdés, Isla Friendship— con testimonios de testigos y análisis de expertos. Hoy sus capítulos están en YouTube.', wiki: 'OVNI_(programa_de_televisión)', caseId: 'friendship-1984', themes: ['encuentros'] },
  ...
  { id: 'testigo-otro-mundo-2018', title: 'Testigo de otro mundo', year: 2018, director: 'Alan Stivelman', type: 'documental', synopsis: 'El caso del gaucho Juan Pérez, que a los 12 años dijo haber tenido contacto con seres en un campo de Venado Tuerto. Stivelman lo acompaña junto al astrofísico Jacques Vallée y chamanes guaraníes a resignificar la experiencia.', wiki: 'Witness_of_Another_World', caseId: 'juan-perez-1978', themes: ['encuentros'] },
];
